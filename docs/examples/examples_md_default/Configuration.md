...
- [22. Property `JSON Schema for Humans configuration file > extra_fields`](#extra_fields)
  - [22.1. Property `JSON Schema for Humans configuration file > extra_fields > additionalProperties`](#extra_fields_additionalProperties)
- [23. ~~Property `JSON Schema for Humans configuration file > allow_html_description`~~](#allow_html_description)
- [24. ~~Property `JSON Schema for Humans configuration file > minify`~~](#minify)
- [25. ~~Property `JSON Schema for Humans configuration file > templates_directory`~~](#templates_directory)
...
## <a name="extra_fields"></a>22. Property `JSON Schema for Humans configuration file > extra_fields`

|                           |                                                                                           |
| ------------------------- | ----------------------------------------------------------------------------------------- |
| **Type**                  | `object`                                                                                  |
| **Required**              | No                                                                                        |
| **Additional properties** | [Each additional property must conform to the schema](#extra_fields_additionalProperties) |
| **Default**               | `{}`                                                                                      |
...
## <a name="allow_html_description"></a>23. ~~Property `JSON Schema for Humans configuration file > allow_html_description`~~
...
## <a name="minify"></a>24. ~~Property `JSON Schema for Humans configuration file > minify`~~
...
## <a name="templates_directory"></a>25. ~~Property `JSON Schema for Humans configuration file > templates_directory`~~
