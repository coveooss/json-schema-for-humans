...
| -------- | ------- | ---- | -------- | ---------- | ---------- | ----------- |
| [it_s_hard_to_explain](#it_s_hard_to_explain)|No|Combination|No|No| No|This property is really complicated. To explain it we need a whole lot of text,  ...|
