...
- [1. ![made-with-Markdown](https://img.shields.io/badge/Optional-yellow) Property `root > a_gift`](#a_gift)
- [2. ![made-with-Markdown](https://img.shields.io/badge/Optional-yellow) Property `root > anchor_with_slash`](#anchor_with_slash)
  - [2.1. ![made-with-Markdown](https://img.shields.io/badge/Optional-yellow) Property `root > anchor_with_slash > propertyA`](#anchor_with_slash_propertyA)
- [3. ![made-with-Markdown](https://img.shields.io/badge/Optional-yellow) Property `root > anchor_no_slash`](#anchor_no_slash)
- [4. ![made-with-Markdown](https://img.shields.io/badge/Optional-yellow) Property `root > anchor_nested_reference`](#anchor_nested_reference)
- [5. ![made-with-Markdown](https://img.shields.io/badge/Optional-yellow) Property `root > same_file_anchor_with_slash`](#same_file_anchor_with_slash)
- [6. ![made-with-Markdown](https://img.shields.io/badge/Optional-yellow) Property `root > same_file_anchor_no_slash`](#same_file_anchor_no_slash)
- [7. ![made-with-Markdown](https://img.shields.io/badge/Optional-yellow) Property `root > same_file_nested_reference`](#same_file_nested_reference)
- [8. ![made-with-Markdown](https://img.shields.io/badge/Optional-yellow) Property `root > other_file_anchor`](#other_file_anchor)
  - [8.1. ![made-with-Markdown](https://img.shields.io/badge/Optional-yellow) Property `root > other_file_anchor > with_wrap`](#other_file_anchor_with_wrap)
- [9. ![made-with-Markdown](https://img.shields.io/badge/Optional-yellow) Property `root > other_file_dot_anchor`](#other_file_dot_anchor)
- [10. ![made-with-Markdown](https://img.shields.io/badge/Optional-yellow) Property `root > other_file_dot_dot_anchor`](#other_file_dot_dot_anchor)
- [11. ![made-with-Markdown](https://img.shields.io/badge/Optional-yellow) Property `root > other_file_only`](#other_file_only)
  - [11.1. ![made-with-Markdown](https://img.shields.io/badge/Required-blue) Property `root > other_file_only > not_a_string`](#other_file_only_not_a_string)
    - [11.1.1. Must **not** be](#autogenerated_heading_2)
- [12. ![made-with-Markdown](https://img.shields.io/badge/Optional-yellow) Property `root > multi_hierarchy_reference`](#multi_hierarchy_reference)
  - [12.1. ![made-with-Markdown](https://img.shields.io/badge/Optional-yellow) Property `root > multi_hierarchy_reference > propertyA`](#multi_hierarchy_reference_propertyA)
...
## <a name="anchor_with_slash"></a>2. ![made-with-Markdown](https://img.shields.io/badge/Optional-yellow) Property `root > anchor_with_slash`
...
## <a name="anchor_no_slash"></a>3. ![made-with-Markdown](https://img.shields.io/badge/Optional-yellow) Property `root > anchor_no_slash`
...
## <a name="anchor_nested_reference"></a>4. ![made-with-Markdown](https://img.shields.io/badge/Optional-yellow) Property `root > anchor_nested_reference`
...
## <a name="same_file_anchor_no_slash"></a>6. ![made-with-Markdown](https://img.shields.io/badge/Optional-yellow) Property `root > same_file_anchor_no_slash`
...
## <a name="other_file_dot_dot_anchor"></a>10. ![made-with-Markdown](https://img.shields.io/badge/Optional-yellow) Property `root > other_file_dot_dot_anchor`
...
## <a name="other_file_only"></a>11. ![made-with-Markdown](https://img.shields.io/badge/Optional-yellow) Property `root > other_file_only`
